    ...
    if request.method == 'POST':
        ...
        if 'file' in request.FILES:
            ...
            try:
                ...
                logger.info(f"Data extraction started for file: {uploaded_file.name}")
        ...
        #-----------------------------------------------------------------------
                # Pre-Upload Comparation step
                # Extract the existing data from the Database Data model in a structured
                
                
                # Set an event trigger to notify frontend that data extraction is in progress
